...
namespace WindowsFormsAppOrarend
{
    public partial class Form_Orarend : Form
    {
        ...
        {
            if (MessageBox.Show("ki akar lépni?", "kilépés", MessageBoxButtons.YesNo, MessageBoxIcon.Question)==DialogResult.Yes)
            {
        ...
        private void listBox_Nap2_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void listBox_Nap5_SelectedIndexChanged(object sender, EventArgs e)
        {
